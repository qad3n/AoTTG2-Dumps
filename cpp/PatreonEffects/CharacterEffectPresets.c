...
int32_t PatreonEffects_CharacterEffectPresets__ParseOrDefault
                  (System_String_o *raw,MethodInfo *method)

{
  ...
  if (DAT_05703cdf == '\0') {
    il2cpp_init_method_metadata(&MethodInfo_Boolean_TryParse_CharacterEffectType);
    il2cpp_init_method_metadata(&"ToxicSurge");
    il2cpp_init_method_metadata(&"GlowOutline");
    il2cpp_init_method_metadata(&"PlasmaFlow");
    il2cpp_init_method_metadata(&"RoyalAura");
    il2cpp_init_method_metadata(&"FrostEdge");
    il2cpp_init_method_metadata(&"NeonPulse");
    il2cpp_init_method_metadata(&"ColorAmp");
    DAT_05703cdf = '\x01';
  }
  local_1c = 0;
  ...
  if ((char)bVar1 == '\0') {
    ...
    bVar1 = System_Enum__TryParse<Int32Enum>(raw,&local_1c,MethodInfo_Boolean_TryParse_CharacterEffectType);
    if ((char)bVar1 != '\0') {
      return local_1c;
    }
  }
...
PatreonEffects_CharacterEffectPresets__GetPreset
          (PatreonEffects_CharacterEffectPreset_o *__return_storage_ptr__,int32_t type,
          MethodInfo *method)
...

{
  ...
  if (DAT_05703ce0 == '\0') {
    ...
    il2cpp_init_method_metadata(&TypeInfo_CharacterEffectType);
    il2cpp_init_method_metadata(&TypeInfo_string);
    DAT_05703ce0 = '\x01';
  }
  lVar1 = il2cpp_glue_02274930(TypeInfo_string);
                        ...
                        *(System_String_o **)(lVar1 + 0x68) = pSVar2;
                        ...
                        if (10 < *(uint *)(lVar1 + 0x18)) {
                          *(System_String_o **)(lVar1 + 0x70) = pSVar2;
                          il2cpp_runtime_glue(lVar1 + 0x70,pSVar2);
                          **(long **)(TypeInfo_CharacterEffectPresets + 0xb8) = lVar1;
                          il2cpp_runtime_glue(*(undefined8 *)(TypeInfo_CharacterEffectPresets + 0xb8),lVar1);
                          return;
                        }
                      }
                    }
