...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/ThirdParty/MeleeWeaponTrail/Example/Scripts/LookAtTarget.cs  [prior source available (delta unverified)]
// --------------------------------
  ...
  if (pUVar4 != (UnityEngine_Transform_o *)0x0) {
    ...
    if (pUVar4 != (UnityEngine_Transform_o *)0x0) {
      UnityEngine_Transform__LookAt
                (pUVar4,(UnityEngine_Vector3_o)(__this->fields)._lookAtTarget.fields,
                 (MethodInfo *)0x0);
      return;
    }
  }
