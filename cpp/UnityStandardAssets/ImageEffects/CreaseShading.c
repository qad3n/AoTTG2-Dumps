...

{
  ...
  il2cpp_runtime_helper_022b4080(&(__this->fields).blurShader,pUVar1);
  pUVar1 = UnityStandardAssets_ImageEffects_PostEffectsBase__CheckShaderAndCreateMaterial
                     ((UnityStandardAssets_ImageEffects_PostEffectsBase_o *)__this,
  ...
  il2cpp_runtime_helper_022b4080(&(__this->fields).depthFetchShader,pUVar1);
  ...
  uVar2 = il2cpp_runtime_helper_022b4080(&(__this->fields).creaseApplyShader);
...
void UnityStandardAssets_ImageEffects_CreaseShading__OnRenderImage
               (UnityStandardAssets_ImageEffects_CreaseShading_o *__this,UnityEngine_RenderTexture_o *source,
...

{
  ...
  int height_00;
  int width_00;
  UnityStandardAssets_ImageEffects_CreaseShading_o *__this_01;
  int iVar3;
  
  if (g_data_057af0d1 == '\0') {
    il2cpp_runtime_helper_023445d0(&TypeInfo_Graphics);
    il2cpp_runtime_helper_023445d0(&"intensity");
    il2cpp_runtime_helper_023445d0(&"_HrDepthTex");
    il2cpp_runtime_helper_023445d0(&"_LrDepthTex");
  ...
  if (source != (UnityEngine_RenderTexture_o *)0x0) {
    ...
    source_00 = (UnityEngine_Texture_o *)
                UnityEngine_RenderTexture__GetTemporary_4de1d70(width,height,0,(MethodInfo *)0x0);
    width_00 = width / 2;
    height_00 = height / 2;
    source_01 = (UnityEngine_Texture_o *)
                UnityEngine_RenderTexture__GetTemporary_4de1d70(width_00,height_00,0,(MethodInfo *)0x0);
    ...
    if (0 < *(int *)((long)&(__this->fields).createdMaterials + 4)) {
      do {
        ...
        __this_01 = (UnityStandardAssets_ImageEffects_CreaseShading_o *)0x0;
        if (pUVar1 == (UnityEngine_Material_o *)0x0) goto label_04581de6;
        UnityEngine_Material__SetVector
                  (pUVar1,"offsets",
                   (UnityEngine_Vector4_o)(ZEXT416((uint)((__this->fields).intensity * 0.001953125)) << 0x20),
                   (MethodInfo *)0x0);
        pUVar1 = (UnityEngine_Material_o *)(__this->fields).blurShader;
        if (*(int *)(TypeInfo_Graphics + 0xe4) == 0) {
          il2cpp_runtime_helper_02337ed0();
        ...
        UnityEngine_Material__SetVector
                  (pUVar1,"offsets",
                   ...
                   ZEXT416((uint)(((__this->fields).intensity * 0.001953125) / ((float)width / (float)height))
                          ),(MethodInfo *)0x0);
        UnityEngine_Graphics__Blit_4dc2ad0
      ...
      if (pUVar1 != (UnityEngine_Material_o *)0x0) {
        ...
        if (pUVar1 != (UnityEngine_Material_o *)0x0) {
          UnityEngine_Material__SetFloat
                    (pUVar1,"intensity",*(float *)&(__this->fields).createdMaterials,(MethodInfo *)0x0);
          pUVar1 = (UnityEngine_Material_o *)(__this->fields).creaseApplyShader;
          if (*(int *)(TypeInfo_Graphics + 0xe4) == 0) {
            il2cpp_runtime_helper_02337ed0();
          }
...
label_04581de6:
  ...
  (__this_01->fields).createdMaterials = (System_Collections_Generic_List_Material__o *)0x13f000000;
  (__this_01->fields).intensity = 1.0;
