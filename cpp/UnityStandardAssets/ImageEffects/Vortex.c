...
// Prior real C# source (REFERENCE, outdated): Assets/ThirdParty/Standard Assets/Effects/ImageEffects/Scripts/Vortex.cs  [prior source available (delta unverified)]
// --------------------------------
...
void UnityStandardAssets_ImageEffects_Vortex__OnRenderImage
               (UnityStandardAssets_ImageEffects_Vortex_o *__this,
