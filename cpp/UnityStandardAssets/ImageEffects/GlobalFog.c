...
// Prior real C# source (REFERENCE, outdated): Assets/ThirdParty/Standard Assets/Effects/ImageEffects/Scripts/GlobalFog.cs  [prior source available (delta unverified)]
// --------------------------------
...

{
  ...
  *(MethodInfo **)&(__this->fields).height = method_00;
  uVar1 = il2cpp_runtime_glue(&(__this->fields).height);
...
void UnityStandardAssets_ImageEffects_GlobalFog__OnRenderImage
               (UnityStandardAssets_ImageEffects_GlobalFog_o *__this,
...

{
  ...
  char cVar5;
  int32_t iVar6;
  UnityEngine_Camera_o *__this_04;
  ...
  if (DAT_05705259 == '\0') {
    ...
    il2cpp_init_method_metadata(&"_SceneFogMode");
    il2cpp_init_method_metadata(&"_CameraWS");
    il2cpp_init_method_metadata(&"_HeightParams");
    il2cpp_init_method_metadata(&"_SceneFogParams");
    il2cpp_init_method_metadata(&"_DistanceParams");
    il2cpp_init_method_metadata(&"_FrustumCornersWS");
    DAT_05705259 = '\x01';
  }
  uStack_d8 = 0;
  uStack_d0 = 0;
  ...
  __this_04 = (UnityEngine_Camera_o *)
              UnityEngine_Component__GetComponent<object>
                        ((UnityEngine_Component_o *)__this,MethodInfo_Camera_GetComponent_Camera);
  if (__this_04 != (UnityEngine_Camera_o *)0x0) {
    __this_05 = UnityEngine_Component__get_transform
                          ((UnityEngine_Component_o *)__this_04,(MethodInfo *)0x0);
    outCorners = (UnityEngine_Vector3_array *)il2cpp_glue_02274930(TypeInfo_Vector3);
    fVar7 = UnityEngine_Camera__get_farClipPlane(__this_04,(MethodInfo *)0x0);
    iVar6 = UnityEngine_Camera__get_stereoActiveEye(__this_04,(MethodInfo *)0x0);
    UnityEngine_Camera__CalculateFrustumCorners
              (__this_04,(UnityEngine_Rect_o)(ZEXT816(0x3f8000003f800000) << 0x40),fVar7,iVar6,
               outCorners,(MethodInfo *)0x0);
    if (outCorners != (UnityEngine_Vector3_array *)0x0) {
      if ((int)outCorners->max_length != 0) {
        if (__this_05 == (UnityEngine_Transform_o *)0x0) goto LAB_0425da97;
        uVar10 = 0;
        uVar11 = 0;
        uVar12 = 0;
        UVar14 = UnityEngine_Transform__TransformVector
                           (__this_05,outCorners->m_Items[0].fields,(MethodInfo *)0x0);
        fStack_a8 = UVar14.fields.z;
        uStack_a4 = uVar10;
        uStack_a0 = uVar11;
        uStack_9c = uVar12;
        if ((1 < (uint)outCorners->max_length) &&
           (row_01.fields._0_12_ =
                 UnityEngine_Transform__TransformVector
                           (__this_05,outCorners->m_Items[1].fields,(MethodInfo *)0x0),
           2 < (uint)outCorners->max_length)) {
          uVar10 = 0;
          uVar11 = 0;
          uVar12 = 0;
          UVar15 = UnityEngine_Transform__TransformVector
                             (__this_05,outCorners->m_Items[2].fields,(MethodInfo *)0x0);
          ...
          uStack_90 = uVar11;
          uStack_8c = uVar12;
          if (3 < (uint)outCorners->max_length) {
            uVar10 = 0;
            uVar11 = 0;
            uVar12 = 0;
            UVar15 = UnityEngine_Transform__TransformVector
                               (__this_05,outCorners->m_Items[3].fields,(MethodInfo *)0x0);
            ...
            value_01.fields._0_12_ =
                 UnityEngine_Transform__get_position(__this_05,(MethodInfo *)0x0);
            ...
            if (pUVar2 != (UnityEngine_Material_o *)0x0) {
              ...
              if (pUVar2 != (UnityEngine_Material_o *)0x0) {
                ...
                if (pUVar2 != (UnityEngine_Material_o *)0x0) {
                  ...
                  value_02.fields.x =
                       (float)*(undefined4 *)((long)&(__this->fields).createdMaterials + 4);
                  ...
                  if (pUVar2 != (UnityEngine_Material_o *)0x0) {
                    ...
                    uVar3 = CONCAT44(*(undefined4 *)(&DAT_00cd0da8 + (ulong)(cVar5 == '\0') * 4),
                                     fVar7) ^ 0x80000000;
                    ...
                    if (pUVar2 != (UnityEngine_Material_o *)0x0) {
                      ...
                      UnityEngine_Material__SetVector
                                (pUVar2,"_SceneFogParams",value_00,(MethodInfo *)0x0);
                      pUVar2 = *(UnityEngine_Material_o **)&(__this->fields).height;
                      if (pUVar2 != (UnityEngine_Material_o *)0x0) {
                        ...
                        UnityEngine_Material__SetVector
                                  (pUVar2,"_SceneFogMode",value_04,(MethodInfo *)0x0);
                        ...
                        UnityEngine_Graphics__Blit
                                  ((UnityEngine_Texture_o *)source,destination,pUVar2,iVar6,
                                   (MethodInfo *)0x0);
                        return;
                      }
                    }
