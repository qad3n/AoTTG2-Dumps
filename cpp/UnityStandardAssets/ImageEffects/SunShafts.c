...
// Prior real C# source (REFERENCE, outdated): Assets/ThirdParty/Standard Assets/Effects/ImageEffects/Scripts/SunShafts.cs  [prior source available (delta unverified)]
// --------------------------------
...

{
  ...
  il2cpp_runtime_glue(&(__this->fields).sunShaftsShader,pUVar1);
  ...
  uVar2 = il2cpp_runtime_glue(&(__this->fields).simpleClearShader);
...
void UnityStandardAssets_ImageEffects_SunShafts__OnRenderImage
               (UnityStandardAssets_ImageEffects_SunShafts_o *__this,
...

{
  ...
  if (DAT_05705283 == '\0') {
    ...
    il2cpp_init_method_metadata(&"_Skybox");
    il2cpp_init_method_metadata(&"_ColorBuffer");
    il2cpp_init_method_metadata(&"_SunColor");
    il2cpp_init_method_metadata(&"_SunThreshold");
    il2cpp_init_method_metadata(&"_SunPosition");
    il2cpp_init_method_metadata(&"_BlurRadius4");
    DAT_05705283 = '\x01';
  }
  ...
  if (*(char *)&(__this->fields).sunShaftIntensity != '\0') {
    ...
    if (pUVar9 == (UnityEngine_Camera_o *)0x0) goto LAB_042634ea;
  ...
  exists = *(UnityEngine_Object_o **)&(__this->fields).resolution;
  if (*(int *)(TypeInfo_Object + 0xe4) == 0) {
    il2cpp_init_class();
  }
  bVar7 = UnityEngine_Object__op_Implicit(exists,(MethodInfo *)0x0);
  if ((char)bVar7 == '\0') {
    ...
    pUVar9 = (UnityEngine_Camera_o *)
             UnityEngine_Component__GetComponent<object>
                       ((UnityEngine_Component_o *)__this,MethodInfo_Camera_GetComponent_Camera);
    __this_00 = *(UnityEngine_Transform_o **)&(__this->fields).resolution;
    if ((__this_00 == (UnityEngine_Transform_o *)0x0) ||
       (UVar16 = UnityEngine_Transform__get_position(__this_00,(MethodInfo *)0x0),
       pUVar9 == (UnityEngine_Camera_o *)0x0)) goto LAB_042634ea;
    UVar16 = UnityEngine_Camera__WorldToViewportPoint(pUVar9,UVar16,(MethodInfo *)0x0);
  ...
  if (source != (UnityEngine_RenderTexture_o *)0x0) {
    ...
    source_00 = (UnityEngine_Texture_o *)
                UnityEngine_RenderTexture__GetTemporary(width_00,iVar8,0,(MethodInfo *)0x0);
      ...
      if (pUVar4 != (UnityEngine_Material_o *)0x0) {
        ...
        if (pUVar4 != (UnityEngine_Material_o *)0x0) {
          UnityEngine_Material__SetVector
                     ...
                     *(UnityEngine_Vector4_Fields *)&(__this->fields).sunColor.fields.b,
                     (MethodInfo *)0x0);
          if (*(char *)&(__this->fields).sunShaftIntensity == '\0') {
            pUVar9 = (UnityEngine_Camera_o *)
                     UnityEngine_Component__GetComponent<object>
            ...
            pUVar4 = (UnityEngine_Material_o *)(__this->fields).sunShaftsShader;
            if (pUVar4 == (UnityEngine_Material_o *)0x0) goto LAB_042634ea;
          ...
          *(int *)&(__this->fields).sunTransform = iVar11;
          ...
          if (pUVar4 != (UnityEngine_Material_o *)0x0) {
            ...
            if (pUVar4 != (UnityEngine_Material_o *)0x0) {
              ...
              UnityEngine_Material__SetVector(pUVar4,"_SunPosition",value_02,(MethodInfo *)0x0);
              if (0 < *(int *)&(__this->fields).sunTransform) {
                do {
                  ...
                  UnityEngine_Graphics__Blit
                            (source_00,(UnityEngine_RenderTexture_o *)source_01,pUVar4,1,
                             (MethodInfo *)0x0);
                  UnityEngine_RenderTexture__ReleaseTemporary
                  ...
                  value_03.fields.x =
                       ((fVar12 + 1.0) * 6.0 * (__this->fields).sunThreshold.fields.b) / 768.0;
                  ...
                  UnityEngine_Graphics__Blit
                            (source_01,(UnityEngine_RenderTexture_o *)source_00,
                             (UnityEngine_Material_o *)(__this->fields).sunShaftsShader,1,
                             (MethodInfo *)0x0);
                  UnityEngine_RenderTexture__ReleaseTemporary
                  ...
                  if (pUVar4 == (UnityEngine_Material_o *)0x0) goto LAB_042634ea;
                  value_04.fields.x =
                       ((fVar12 + 2.0) * 6.0 * (__this->fields).sunThreshold.fields.b) / 768.0;
                  value_04.fields.y = value_04.fields.x;
                  value_04.fields.z = 0.0;
                  value_04.fields.w = 0.0;
                  UnityEngine_Material__SetVector(pUVar4,"_BlurRadius4",value_04,(MethodInfo *)0x0);
                  iVar11 = iVar11 + 1;
              ...
              if (pUVar4 != (UnityEngine_Material_o *)0x0) {
                ...
                UnityEngine_Graphics__Blit
                          ((UnityEngine_Texture_o *)source,destination,pUVar4,
                           (uint)(iVar8 != 0) << 2,(MethodInfo *)0x0);
                UnityEngine_RenderTexture__ReleaseTemporary
                          ((UnityEngine_RenderTexture_o *)source_00,(MethodInfo *)0x0);
                return;
              }
