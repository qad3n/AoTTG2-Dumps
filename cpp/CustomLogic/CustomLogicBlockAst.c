...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/CustomLogic/Ast/CustomLogicBlockAst.cs  [prior source available (delta unverified)]
// --------------------------------
...
void CustomLogic_CustomLogicBlockAst___ctor
               (CustomLogic_CustomLogicBlockAst_o *__this,int32_t type,int32_t line,
               MethodInfo *method)
