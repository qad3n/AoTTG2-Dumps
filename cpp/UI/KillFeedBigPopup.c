...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/UI/InGameMenu/KillFeedBigPopup.cs  [CHANGED since prior version]
// --------------------------------
...
int32_t UI_KillFeedBigPopup__get_PopupAnimationType
                  (UI_KillFeedBigPopup_o *__this,MethodInfo *method)
...
void UI_KillFeedBigPopup__Setup
               (UI_KillFeedBigPopup_o *__this,UI_BasePanel_o *parent,MethodInfo *method)

{
  ...
  if (DAT_05704697 == '\0') {
    ...
    il2cpp_init_method_metadata(&"Prefabs/InGame/KillFeedLabelBig");
  ...
  ;
  pUVar2 = UI_ElementFactory__InstantiateAndBind(pUVar1,"Prefabs/InGame/KillFeedLabelBig",(MethodInfo *)0x0);
...
void UI_KillFeedBigPopup__Show
               (UI_KillFeedBigPopup_o *__this,System_String_o *killer,System_String_o *victim,
...

{
  ...
  pMVar4 = extraout_RDX;
  if (*(int *)((long)&(TypeInfo_ResourcePaths->fields).Victim + 4) == 0) {
    il2cpp_init_class();
    pMVar4 = extraout_RDX_00;
  }
  pUVar3 = ((TypeInfo_ResourcePaths->fields)._scoreLabel)->klass;
  pSVar2 = UI_KillFeedBigPopup__GetWeaponIcon(TypeInfo_ResourcePaths,weapon,pMVar4);
  ...
  if (__this_00 != (UnityEngine_UI_RawImage_o *)0x0) {
    ...
    if (pUVar1 != (UnityEngine_UI_Text_o *)0x0) {
      ...
      if (pUVar1 != (UnityEngine_UI_Text_o *)0x0) {
        ...
        pSVar2 = System_Int32__ToString((int32_t)&local_3c,(MethodInfo *)0x0);
        if (pUVar1 != (UnityEngine_UI_Text_o *)0x0) {
          (*(pUVar1->klass->vtable)._75_set_text.methodPtr)
          ...
          if (pUVar1 != (UnityEngine_UI_Text_o *)0x0) {
            ...
            pUVar1 = (__this->fields)._backgroundLabel;
            if (local_3c < 1000) {
              if (pUVar1 == (UnityEngine_UI_Text_o *)0x0) goto LAB_040be325;
              pUVar3 = pUVar1->klass;
              pMVar4 = (pUVar3->vtable)._23_set_color.method;
              uVar6 = 0x3f800000;
            }
            else {
              if (pUVar1 == (UnityEngine_UI_Text_o *)0x0) goto LAB_040be325;
            ...
            (*(pUVar3->vtable)._23_set_color.methodPtr)(0x3f800000,uVar6,pUVar1,pMVar4);
            *(undefined1 *)&(__this->fields).IsActive = 0;
            fVar5 = (float)(*(__this->klass->vtable)._51_get_AnimationTime.methodPtr)(__this);
            (__this->fields).TimeLeft = fVar5 + 8.0;
...
System_String_o *
UI_KillFeedBigPopup__GetWeaponIcon
          (UI_KillFeedBigPopup_o *__this,System_String_o *weapon,MethodInfo *method)
