...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/CustomSkins/CustomSkinParts/HumanHairCustomSkinPart.cs  [CHANGED since prior version]
// --------------------------------
...
void CustomSkins_HumanHairCustomSkinPart___ctor
               (CustomSkins_HumanHairCustomSkinPart_o *__this,
...

{
  ...
  il2cpp_runtime_glue(&(__this->fields)._hairTexture,hairTexture);
  return;
}
...
CustomSkins_HumanHairCustomSkinPart__SetNewTexture
          (CustomSkins_HumanHairCustomSkinPart_o *__this,UnityEngine_Texture2D_o *texture,
          MethodInfo *method)

{
  System_Collections_Generic_List_Renderer__o *pSVar1;
  System_String_o *texture_00;
  bool_conflict bVar2;
      ...
      if (pSVar1 != (System_Collections_Generic_List_Renderer__o *)0x0) {
        ...
        if (__this_00 != (CustomSkins_BaseCustomSkinPart_o *)0x0) {
          ...
          if ((char)bVar2 == '\0') {
            ...
            if ((char)bVar2 == '\0') goto LAB_04247ea6;
            pSVar1 = (__this->fields)._renderers;
            if (pSVar1 != (System_Collections_Generic_List_Renderer__o *)0x0) {
              ...
              texture_00 = (__this->fields)._hairTexture;
              if (*(int *)(TypeInfo_HumanSetupMaterials + 0xe4) == 0) {
                il2cpp_init_class();
              }
              pUVar3 = Characters_HumanSetupMaterials__GetHairMaterial(texture_00,(MethodInfo *)0x0)
              ;
