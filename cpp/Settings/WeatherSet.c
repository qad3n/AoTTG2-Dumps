...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Settings/InGame/WeatherSet.cs  [prior source available (delta unverified)]
// --------------------------------
...

{
  ...
  Settings_StringSetting___ctor(pSVar1,"Day1",0x7fffffff,(MethodInfo *)0x0);
  (__this->fields).Skybox = pSVar1;
  il2cpp_runtime_glue(&(__this->fields).Skybox,pSVar1);
  ...
  il2cpp_runtime_glue(&(__this->fields).SkyboxColor,pSVar3);
  pUVar2 = (Utility_Color255_o *)il2cpp_runtime_glue(TypeInfo_Color255);
  Utility_Color255___ctor(pUVar2,0xff,0xff,0xff,0xff,(MethodInfo *)0x0);
  pSVar3 = (Settings_ColorSetting_o *)il2cpp_runtime_glue(TypeInfo_ColorSetting);
  Settings_ColorSetting___ctor(pSVar3,pUVar2,0,(MethodInfo *)0x0);
  (__this->fields).Daylight = pSVar3;
  il2cpp_runtime_glue(&(__this->fields).Daylight);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,1.0,0.0,2.0,(MethodInfo *)0x0);
  (__this->fields).DaylightIntensity = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).DaylightIntensity);
  pSVar5 = (Settings_Vector3Setting_o *)il2cpp_runtime_glue(TypeInfo_Vector3Setting);
  Settings_Vector3Setting___ctor
            (pSVar5,(UnityEngine_Vector3_o)ZEXT812(0x4234000042340000),(MethodInfo *)0x0);
  (__this->fields).DaylightDirection = pSVar5;
  il2cpp_runtime_glue(&(__this->fields).DaylightDirection,pSVar5);
  pUVar2 = (Utility_Color255_o *)il2cpp_runtime_glue(TypeInfo_Color255);
  Utility_Color255___ctor(pUVar2,0x7e,0x7a,0x72,0xff,(MethodInfo *)0x0);
  pSVar3 = (Settings_ColorSetting_o *)il2cpp_runtime_glue(TypeInfo_ColorSetting);
  Settings_ColorSetting___ctor(pSVar3,pUVar2,0,(MethodInfo *)0x0);
  (__this->fields).AmbientLight = pSVar3;
  il2cpp_runtime_glue(&(__this->fields).AmbientLight,pSVar3);
  pUVar2 = (Utility_Color255_o *)il2cpp_runtime_glue(TypeInfo_Color255);
  Utility_Color255___ctor(pUVar2,0xff,0xff,0xff,0,(MethodInfo *)0x0);
  pSVar3 = (Settings_ColorSetting_o *)il2cpp_runtime_glue(TypeInfo_ColorSetting);
  Settings_ColorSetting___ctor(pSVar3,pUVar2,0,(MethodInfo *)0x0);
  (__this->fields).Flashlight = pSVar3;
  il2cpp_runtime_glue(&(__this->fields).Flashlight);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,1.0,(MethodInfo *)0x0);
  (__this->fields).FogDensity = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).FogDensity,pSVar4);
  pUVar2 = (Utility_Color255_o *)il2cpp_runtime_glue(TypeInfo_Color255);
  Utility_Color255___ctor(pUVar2,0x80,0x80,0x80,0xff,(MethodInfo *)0x0);
  pSVar3 = (Settings_ColorSetting_o *)il2cpp_runtime_glue(TypeInfo_ColorSetting);
  Settings_ColorSetting___ctor(pSVar3,pUVar2,0,(MethodInfo *)0x0);
  (__this->fields).FogColor = pSVar3;
  il2cpp_runtime_glue(&(__this->fields).FogColor);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,1.0,(MethodInfo *)0x0);
  (__this->fields).Rain = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).Rain);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,1.0,(MethodInfo *)0x0);
  (__this->fields).Thunder = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).Thunder);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,1.0,(MethodInfo *)0x0);
  (__this->fields).Snow = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).Snow);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,1.0,(MethodInfo *)0x0);
  ...
  pSVar5 = (Settings_Vector3Setting_o *)il2cpp_runtime_glue(TypeInfo_Vector3Setting);
  Settings_Vector3Setting___ctor
            (pSVar5,(UnityEngine_Vector3_o)ZEXT412(0x3f800000),(MethodInfo *)0x0);
  (__this->fields).WindDirection = pSVar5;
  il2cpp_runtime_glue(&(__this->fields).WindDirection);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,100000.0,(MethodInfo *)0x0);
  (__this->fields).RainForce = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).RainForce);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,100000.0,(MethodInfo *)0x0);
  (__this->fields).SnowForce = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).SnowForce);
  pSVar4 = (Settings_FloatSetting_o *)il2cpp_runtime_glue(TypeInfo_FloatSetting);
  Settings_FloatSetting___ctor(pSVar4,0.0,0.0,100000.0,(MethodInfo *)0x0);
  (__this->fields).WindForce = pSVar4;
  il2cpp_runtime_glue(&(__this->fields).WindForce);
  pSVar6 = (Settings_BoolSetting_o *)il2cpp_runtime_glue(TypeInfo_BoolSetting);
  Settings_BoolSetting___ctor(pSVar6,0,(MethodInfo *)0x0);
  (__this->fields).UseSchedule = pSVar6;
  il2cpp_runtime_glue(&(__this->fields).UseSchedule);
  pSVar6 = (Settings_BoolSetting_o *)il2cpp_runtime_glue(TypeInfo_BoolSetting);
  Settings_BoolSetting___ctor(pSVar6,0,(MethodInfo *)0x0);
  (__this->fields).ScheduleLoop = pSVar6;
  il2cpp_runtime_glue(&(__this->fields).ScheduleLoop,pSVar6);
  defaultValue = (System_String_o *)**(undefined8 **)(DAT_057110b0 + 0xb8);
  pSVar1 = (Settings_StringSetting_o *)il2cpp_runtime_glue(TypeInfo_StringSetting);
  Settings_StringSetting___ctor(pSVar1,defaultValue,0x7fffffff,(MethodInfo *)0x0);
