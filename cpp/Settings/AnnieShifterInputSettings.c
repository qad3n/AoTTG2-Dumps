...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Settings/Input/AnnieShifterInputSettings.cs  [prior source available (delta unverified)]
// --------------------------------
...
{
  if (DAT_0570274a == '\0') {
    il2cpp_init_method_metadata(&"AnnieShifterInput.json");
    DAT_0570274a = '\x01';
  }
  ...
  if (pSVar1 != (System_String_array *)0x0) {
    if ((int)pSVar1->max_length != 0) {
      ...
      if (1 < (uint)pSVar1->max_length) {
        ...
        pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
        if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
        if ((int)pSVar1->max_length != 0) {
              ...
              if (1 < (uint)pSVar1->max_length) {
                ...
                if ((int)pSVar1->max_length != 0) {
                  ...
                  if (1 < (uint)pSVar1->max_length) {
                    ...
                    il2cpp_runtime_glue(&(__this->fields).AttackCombo,pSVar2);
                    pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
                    if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                    if ((int)pSVar1->max_length != 0) {
                      ...
                      if (1 < (uint)pSVar1->max_length) {
                        ...
                        il2cpp_runtime_glue(&(__this->fields).AttackSwing,pSVar2);
                        pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
                        if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                        if ((int)pSVar1->max_length != 0) {
                          pSVar1->m_Items[0] = "Q";
                          ...
                          if (1 < (uint)pSVar1->max_length) {
                            ...
                            il2cpp_runtime_glue(&(__this->fields).AttackStomp,pSVar2);
                            pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
                            if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                            if ((int)pSVar1->max_length != 0) {
                              pSVar1->m_Items[0] = "E";
                              ...
                              if (1 < (uint)pSVar1->max_length) {
                                ...
                                il2cpp_runtime_glue(&(__this->fields).AttackBite,pSVar2);
                                pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
                                if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                                if ((int)pSVar1->max_length != 0) {
                                  ...
                                  if (1 < (uint)pSVar1->max_length) {
                                    ...
                                    il2cpp_runtime_glue(&(__this->fields).AttackHead,pSVar2);
                                    pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2);
                                    if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                                    if ((int)pSVar1->max_length != 0) {
                                      ...
                                      if (1 < (uint)pSVar1->max_length) {
                                        ...
                                        il2cpp_runtime_glue(&(__this->fields).AttackBrushBack,pSVar2)
                                        ;
                                        pSVar1 = (System_String_array *)il2cpp_glue_02274930(TypeInfo_string,2)
                                        ;
                                        if (pSVar1 == (System_String_array *)0x0) goto LAB_03d97476;
                                        if ((int)pSVar1->max_length != 0) {
                                          ...
                                          if (1 < (uint)pSVar1->max_length) {
                                            ...
                                            il2cpp_runtime_glue(&(__this->fields).AttackBrushFront,
                                                               pSVar2);
                                            ...
                                            if ((int)pSVar1->max_length != 0) {
                                              ...
                                              if (1 < (uint)pSVar1->max_length) {
                                                ...
                                                il2cpp_runtime_glue(&(__this->fields).AttackBrushHead
                                                                   ,pSVar2);
                                                pSVar1 = (System_String_array *)
                                                         il2cpp_glue_02274930(TypeInfo_string,2);
                                                if (pSVar1 == (System_String_array *)0x0)
