...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Settings/AbilitySettings.cs  [CHANGED since prior version]
// --------------------------------
...
{
  if (DAT_0570271a == '\0') {
    il2cpp_init_method_metadata(&"Ability_001.json");
    DAT_0570271a = '\x01';
  }
...

{
  ...
  Settings_ColorSetting___ctor(__this_01,__this_00,0x80,(MethodInfo *)0x0);
  (__this->fields).BombColor = __this_01;
  il2cpp_runtime_glue(&(__this->fields).BombColor,__this_01);
  pSVar1 = (Settings_IntSetting_o *)il2cpp_runtime_glue(TypeInfo_IntSetting);
  Settings_IntSetting___ctor(pSVar1,6,0,10,(MethodInfo *)0x0);
  (__this->fields).BombRadius = pSVar1;
  il2cpp_runtime_glue(&(__this->fields).BombRadius,pSVar1);
  pSVar1 = (Settings_IntSetting_o *)il2cpp_runtime_glue(TypeInfo_IntSetting);
  Settings_IntSetting___ctor(pSVar1,4,0,10,(MethodInfo *)0x0);
  (__this->fields).BombRange = pSVar1;
  il2cpp_runtime_glue(&(__this->fields).BombRange,pSVar1);
  pSVar1 = (Settings_IntSetting_o *)il2cpp_runtime_glue(TypeInfo_IntSetting);
  Settings_IntSetting___ctor(pSVar1,6,0,10,(MethodInfo *)0x0);
  (__this->fields).BombSpeed = pSVar1;
  il2cpp_runtime_glue(&(__this->fields).BombSpeed,pSVar1);
  pSVar1 = (Settings_IntSetting_o *)il2cpp_runtime_glue(TypeInfo_IntSetting);
  Settings_IntSetting___ctor(pSVar1,4,0,10,(MethodInfo *)0x0);
  (__this->fields).BombCooldown = pSVar1;
  il2cpp_runtime_glue(&(__this->fields).BombCooldown);
  ...
  il2cpp_runtime_glue(&(__this->fields).CursorCooldown);
  pSVar2 = (Settings_BoolSetting_o *)il2cpp_runtime_glue(TypeInfo_BoolSetting);
  Settings_BoolSetting___ctor(pSVar2,0,(MethodInfo *)0x0);
  (__this->fields).ShowBombColors = pSVar2;
  il2cpp_runtime_glue(&(__this->fields).ShowBombColors);
  pSVar2 = (Settings_BoolSetting_o *)il2cpp_runtime_glue(TypeInfo_BoolSetting);
  Settings_BoolSetting___ctor(pSVar2,0,(MethodInfo *)0x0);
  (__this->fields).UseOldEffect = pSVar2;
  il2cpp_runtime_glue(&(__this->fields).UseOldEffect);
  pSVar2 = (Settings_BoolSetting_o *)il2cpp_runtime_glue(TypeInfo_BoolSetting);
  Settings_BoolSetting___ctor(pSVar2,0,(MethodInfo *)0x0);
  (__this->fields).BombCollision = pSVar2;
  il2cpp_runtime_glue(&(__this->fields).BombCollision);
