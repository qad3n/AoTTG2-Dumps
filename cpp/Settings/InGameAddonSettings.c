...
Settings_InGameAddonSettings__SerializeToJsonObject
          (Settings_InGameAddonSettings_o *__this,MethodInfo *method)
...
void Settings_InGameAddonSettings__DeserializeFromJsonObject
               (Settings_InGameAddonSettings_o *__this,SimpleJSONFixed_JSONNode_o *json,
               MethodInfo *method)
