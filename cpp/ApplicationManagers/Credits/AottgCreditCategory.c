...

{
  ...
  if (groups == (ApplicationManagers_Credits_AottgCreditGroup_array *)0x0) {
    groups = (ApplicationManagers_Credits_AottgCreditGroup_array *)il2cpp_glue_02274930(TypeInfo_AottgCreditGroup,0);
  }
  pSVar1 = System_Array__AsReadOnly<object>((System_Object_array *)groups,MethodInfo_ReadOnlyCollection_1_ApplicationManagers_Credits);
  (__this->fields)._Groups_k__BackingField =
       (System_Collections_Generic_IReadOnlyList_AottgCreditGroup__o *)pSVar1;
  il2cpp_runtime_glue(&(__this->fields)._Groups_k__BackingField,pSVar1);
  return;
}
...
void ApplicationManagers_Credits_AottgCreditCategory__set_Groups
               (ApplicationManagers_Credits_AottgCreditCategory_o *__this,
               System_Collections_Generic_IReadOnlyList_AottgCreditGroup__o *value,
               MethodInfo *method)

{
  (__this->fields)._Groups_k__BackingField = value;
  il2cpp_runtime_glue(&(__this->fields)._Groups_k__BackingField);
  return;
}
