...

{
  ...
  *(char *)&(__this->fields)._Success_k__BackingField = (char)success;
  ...
  il2cpp_runtime_glue(&(__this->fields)._Profile_k__BackingField,profile);
...

{
  ...
  il2cpp_runtime_glue(&(__this->fields)._Profile_k__BackingField);
  return;
}
...

{
  ...
  __this = (ApplicationManagers_PublicProfiles_AottgPublicProfileFetchResponse_o *)
           il2cpp_runtime_glue(TypeInfo_AottgPublicProfileFetchResponse);
  System_Object___ctor((Il2CppObject *)__this,(MethodInfo *)0x0);
...

{
  ...
  *(undefined1 *)&(__this->fields)._Success_k__BackingField = 0;
  (__this->fields)._Profile_k__BackingField =
       (ApplicationManagers_PublicProfiles_AottgPublicProfile_o *)0x0;
  il2cpp_runtime_glue(&(__this->fields)._Profile_k__BackingField,0);
  (__this->fields)._Error_k__BackingField = error;
  il2cpp_runtime_glue(&(__this->fields)._Error_k__BackingField,error);
  return __this;
}
