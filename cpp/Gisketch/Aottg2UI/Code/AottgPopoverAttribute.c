...
void Gisketch_Aottg2UI_Code_AottgPopoverAttribute___ctor
               (Gisketch_Aottg2UI_Code_AottgPopoverAttribute_o *__this,System_String_o *id,
               MethodInfo *method)
...

{
  ...
  return CONCAT31((int3)((uint)in_EAX >> 8),
                  (char)(__this->fields)._DismissOnBackdrop_k__BackingField);
}
...
void Gisketch_Aottg2UI_Code_AottgPopoverAttribute__set_DismissOnBackdrop
               (Gisketch_Aottg2UI_Code_AottgPopoverAttribute_o *__this,bool_conflict value,
               MethodInfo *method)
