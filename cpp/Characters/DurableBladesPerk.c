...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Characters/Human/Perks/DurableBladesPerk.cs  [prior source available (delta unverified)]
// --------------------------------
...
int32_t Characters_DurableBladesPerk__get_MaxPoints
                  (Characters_DurableBladesPerk_o *__this,MethodInfo *method)
