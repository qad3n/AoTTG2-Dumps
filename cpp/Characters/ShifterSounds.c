...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Characters/Shifters/ShifterSounds.cs  [prior source available (delta unverified)]
// --------------------------------
...

{
  ...
  **(undefined8 **)(TypeInfo_ShifterSounds + 0xb8) = "Thunder";
  il2cpp_runtime_glue(*(undefined8 *)(TypeInfo_ShifterSounds + 0xb8),"Thunder");
