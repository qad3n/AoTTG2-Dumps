...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Characters/Human/Items/FlareItem.cs  [CHANGED since prior version]
// --------------------------------
...
void Characters_FlareItem___ctor
               (Characters_FlareItem_o *__this,Characters_BaseCharacter_o *owner,
               System_String_o *name,UnityEngine_Color_o color,float cooldown,MethodInfo *method)
...

{
  ...
  if (__this_00 == (Characters_BaseCharacter_o *)0x0) goto LAB_03fda17b;
  ...
  if (fVar8 < 0.0) {
    ...
    if (fVar8 <= 1e-05) goto LAB_03fd9ef3;
LAB_03fd9f4f:
    ...
    fVar8 = SQRT(fVar8);
    if (1e-05 < fVar8) goto LAB_03fd9f4f;
LAB_03fd9ef3:
    if (DAT_056fdd15 == '\0') {
      il2cpp_init_method_metadata(&TypeInfo_Vector3);
      DAT_056fdd15 = '\x01';
  ...
  if (*(int *)(TypeInfo_ProjectilePrefabs + 0xe4) == 0) {
    ...
    if (DAT_056fde1e != '\0') goto LAB_03fd9f95;
LAB_03fda15b:
    ...
    name = *(System_String_o **)(*(long *)(TypeInfo_ProjectilePrefabs + 0xb8) + 0x10);
    if (DAT_056fde1e == '\0') goto LAB_03fda15b;
LAB_03fd9f95:
    pCVar4 = (__this->fields)._owner;
  }
  if (((pCVar4 != (Characters_BaseCharacter_o *)0x0) &&
    ...
    pIVar6 = (Il2CppObject *)il2cpp_runtime_glue(TypeInfo_Color,&fStack_38);
    if (settings != (System_Object_array *)0x0) {
      if ((pIVar6 != (Il2CppObject *)0x0) &&
         (lVar7 = il2cpp_runtime_glue(pIVar6,(((settings->obj).klass)->_1).element_class), lVar7 == 0
         )) {
      ...
      il2cpp_runtime_glue(settings->m_Items,pIVar6);
      ...
      Projectiles_ProjectileSpawner__Spawn
                (name,UVar14,(UnityEngine_Quaternion_o)rotation,UVar15,
                 (UnityEngine_Vector3_o)gravity,6.5,charViewId,"",settings,
                 (MethodInfo *)0x0);
