...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Characters/Shifters/Annie/AnnieComponentCache.cs  [prior source available (delta unverified)]
// --------------------------------
...
void Characters_AnnieComponentCache___ctor
               (Characters_AnnieComponentCache_o *__this,UnityEngine_GameObject_o *owner,
               MethodInfo *method)

{
  ...
  if (DAT_057041a1 == '\0') {
    il2cpp_init_method_metadata(&"Armature_FemT/Core/Controller_Body/hip/spine/chest/neck/head");
    il2cpp_init_method_metadata(&"Armature_FemT/Core");
    il2cpp_init_method_metadata(&"Armature_FemT/Core/Controller_Body/hip/spine/chest/neck");
    il2cpp_init_method_metadata(&"Shifters/Prefabs/ShifterSounds");
    il2cpp_init_method_metadata(&"Armature_FemT/Core/Controller_Body/hip");
  ...
  if (pUVar1 != (UnityEngine_Transform_o *)0x0) {
    pUVar1 = UnityEngine_Transform__Find(pUVar1,"Armature_FemT/Core/Controller_Body/hip/spine/chest/neck/head",(MethodInfo *)0x0);
    (__this->fields).Head = pUVar1;
    il2cpp_runtime_glue(&(__this->fields).Head,pUVar1);
    pUVar1 = (__this->fields).Transform;
    if (pUVar1 != (UnityEngine_Transform_o *)0x0) {
      pUVar1 = UnityEngine_Transform__Find(pUVar1,"Armature_FemT/Core/Controller_Body/hip/spine/chest/neck",(MethodInfo *)0x0);
      (__this->fields).Neck = pUVar1;
      il2cpp_runtime_glue(&(__this->fields).Neck,pUVar1);
      pUVar1 = (__this->fields).Transform;
      if (pUVar1 != (UnityEngine_Transform_o *)0x0) {
        pUVar1 = UnityEngine_Transform__Find(pUVar1,"Armature_FemT/Core",(MethodInfo *)0x0);
