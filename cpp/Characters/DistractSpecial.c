...
// Prior real C# source (REFERENCE, outdated): Assets/Scripts/Characters/Human/Specials/DistractSpecial.cs  [CHANGED since prior version]
// --------------------------------
...
float Characters_DistractSpecial__get_ActiveTime
                (Characters_DistractSpecial_o *__this,MethodInfo *method)
...
bool_conflict
Characters_DistractSpecial__get_GroundedOnly
          (Characters_DistractSpecial_o *__this,MethodInfo *method)
...
void Characters_DistractSpecial___ctor
               (Characters_DistractSpecial_o *__this,Characters_BaseCharacter_o *owner,
               MethodInfo *method)
...

{
  ...
  if (__this_00 != (Characters_Human_o *)0x0) {
    Characters_Human__EmoteAnimation
              (__this_00,*(System_String_o **)(*(long *)(TypeInfo_HumanAnimations + 0xb8) + 0x1e0),
               (MethodInfo *)0x0);
    return;
  }
...
LAB_03fe8730:
        do {
          ...
          fVar7 = ((float)local_68[0]._0_4_ - local_88) * ((float)local_68[0]._0_4_ - local_88) +
                  ...
                  fVar7 * fVar7;
          if (fVar7 < 0.0) goto LAB_03fe8850;
          local_30 = pCVar12;
